...
*UART0 is connected to openSDA debug agent and has a virtual 
*connection to the host PC COM port.
*Launch TeraTerm on a PC and hit any key.
*The LED program from P2_7 of Chapter 2 is used to turn on the 
*tri-color LEDsaccording to the key received.
